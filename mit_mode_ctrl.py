...
root.title("AK MIT Mode Controller")
...
frame1.pack()
label_info = tk.Label(
    root, text="Choose the serial port and click connect", padx=20, pady=5
)
label_info.pack()

# label for the slider
tk.Label(root, text="Position:", pady=5).pack()
slider_position = generateSlider(
    -12.5, 12.5, 0, value_position, slider_position_changed
)
